    ...
    >
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center relative z-10">
        ...
        >
          ...
          <button className="inline-flex items-center justify-center px-7 py-3 bg-white text-black font-semibold rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-105 relative">
        ...
        {/* IMAGE */}
        <motion.div
          className="relative rounded-3xl overflow-hidden shadow-2xl hover:scale-[1.03] transition-transform duration-700"
      ...
      <div className="mt-20 flex flex-wrap justify-center gap-10 relative z-10">
        {features.map((feature, index) => (
          <motion.div
            key={index}
            className="group w-56 sm:w-64 p-6 bg-gradient-to-br from-gray-800 to-black rounded-3xl shadow-xl border border-white/10 transition-all duration-700 hover:-translate-y-3 hover:shadow-2xl hover:scale-105"
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7, delay: index * 0.2 }}
          >
            <div className="relative w-28 h-28 mx-auto rounded-full overflow-hidden border-4 border-white/30 shadow-lg transition-transform duration-500 group-hover:scale-110">
