      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center relative z-10 space-y-12">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl font-extrabold leading-tight">
            {t.alleat.heading} <span className="bg-gradient-to-r from-red-400 to-yellow-300 bg-clip-text text-transparent">{t.alleat.headingAccent}</span> {t.alleat.heading2}
          </h2>
          ...
          {/* CREATIVE PHOTO */}
          <motion.div
            className="mt-8 relative w-full h-96 sm:h-[500px] rounded-3xl overflow-hidden shadow-2xl transform hover:scale-105 transition-transform duration-500 border-2 border-red-800/30"
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
          >
            {/* Diagonal clip mask */}
